...
public final  class wwp_masterpagetopactionswc_impl extends GXWebComponent
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.wwpbaseobjects.wwp_masterpagetopactionswc", new String[] {}, new String[] {}) +"\">") ;
   ...
   public void wb0V0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.wwpbaseobjects.wwp_masterpagetopactionswc");
            httpContext.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         }
         ...
         ucBtnaction.setProperty("TooltipText", Btnaction_Tooltiptext);
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202442617163225", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("wwpbaseobjects/wwp_masterpagetopactionswc.js", "?202442617163225", false, true);
         httpContext.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      }
   ...
   public void initialize( )
   {
      ...
      GXKey = "" ;
      GX_FocusControl = "" ;
      ucBtnaction = new com.genexus.webpanels.GXUserControl();
      sXEvt = "" ;
      sEvt = "" ;
      EvtGridId = "" ;
      EvtRowId = "" ;
   ...
   private String Btnaction_Tooltiptext ;
   ...
   private com.genexus.webpanels.GXUserControl ucBtnaction ;
}
