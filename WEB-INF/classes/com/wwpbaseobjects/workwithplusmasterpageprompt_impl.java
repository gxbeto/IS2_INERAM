...
public final  class workwithplusmasterpageprompt_impl extends GXMasterPage
{
   ...
   public void renderHtmlCloseForm032( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageprompt.js", "?202442617164773", false, true);
   ...
   public void e11032( )
   {
      ...
      if ( GXutil.strcmp(AV5HttpRequest.getMethod(), "GET") == 0 )
      {
         ...
         this.executeExternalObjectMethod("", true, "gx.core.ds", "setOption", new Object[] {"menu-color",AV6WWP_DesignSystemSettings.getgxTv_SdtWWP_DesignSystemSettings_Menucolor()}, false);
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?202442617164842", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageprompt.js", "?202442617164842", false, true);
         httpContext.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
         httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
   ...
   public void initialize( )
   {
      ...
      AV6WWP_DesignSystemSettings = new com.wwpbaseobjects.SdtWWP_DesignSystemSettings(remoteHandle, context);
   ...
   private com.wwpbaseobjects.SdtWWP_DesignSystemSettings AV6WWP_DesignSystemSettings ;
