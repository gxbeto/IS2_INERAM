...
public final  class samplelogin_impl extends GXDataArea
{
   public samplelogin_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public samplelogin_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( samplelogin_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormBackgroundImage\" data-gx-class=\"form-horizontal FormBackgroundImage\" novalidate action=\""+formatLink("com.wwpbaseobjects.samplelogin", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      return formatLink("com.wwpbaseobjects.samplelogin", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb050( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.GxWebStd.gx_bitmap( httpContext, imgLogologin_Internalname, sImgUrl, "", "", "", context.getHttpContext().getTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.getHttpContext().getImageSrcSet( sImgUrl), "HLP_WWPBaseObjects/SampleLogin.htm");
         ...
         /* Text block */
         com.GxWebStd.gx_label_ctrl( httpContext, lblForgotpassword_Internalname, "¿Se te olvidó tu contraseña?", "", "", lblForgotpassword_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "DataDescriptionLogin", 0, "", 1, 1, 0, (short)(1), "HLP_WWPBaseObjects/SampleLogin.htm");
         com.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.GxWebStd.gx_button_ctrl( httpContext, bttBtnenter_Internalname, "", "Iniciar sesión", bttBtnenter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_WWPBaseObjects/SampleLogin.htm");
         com.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         com.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         /* Div Control */
         com.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         /* Div Control */
         com.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCellLogin CellPaddingLogin", "start", "top", "", "", "div");
         wb_table1_35_052( true) ;
      }
      else
      {
         wb_table1_35_052( false) ;
      }
      return  ;
   }

   public void wb_table1_35_052e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
   ...
   public void wb_table1_35_052( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         /* Text block */
         com.GxWebStd.gx_label_ctrl( httpContext, lblNoaccount_Internalname, "¿Aún no tienes cuenta?", "", "", lblNoaccount_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects/SampleLogin.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /* Text block */
         com.GxWebStd.gx_label_ctrl( httpContext, lblRegisteruser_Internalname, "Crear una ahora", "", "", lblRegisteruser_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "DataDescriptionLogin", 0, "", 1, 1, 0, (short)(0), "HLP_WWPBaseObjects/SampleLogin.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_35_052e( true) ;
      }
      else
      {
         wb_table1_35_052e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202442617165048", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("wwpbaseobjects/samplelogin.js", "?202442617165048", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Mask/jquery.mask.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/WorkWithPlusUtilities/BootstrapSelect.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/WorkWithPlusUtilities/WorkWithPlusUtilitiesRender.js", "", false, true);
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("ENTER","{handler:'e12052',iparms:[]");
