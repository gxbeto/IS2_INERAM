...
public final  class wwp_parameterww_impl extends GXDataArea
{
   public wwp_parameterww_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public wwp_parameterww_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( wwp_parameterww_impl.class ));
   }
   ...
   public void gxgrgrid_refresh_invoke( )
   {
      ...
      gxgrgrid_refresh( subGrid_Rows, AV19FilterFullText, AV29ManageFiltersExecutionStep, AV47Pgmname, AV16OrderedBy, AV17OrderedDsc) ;
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.workwithplus.wwp_parameterww", new String[] {}, new String[] {}) +"\">") ;
   ...
   {
      com.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV47Pgmname));
      com.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV47Pgmname, ""))));
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.GxWebStd.gx_hidden_field( httpContext, "GXH_vFILTERFULLTEXT", AV19FilterFullText);
      /* Send saved values. */
      ...
      com.GxWebStd.gx_hidden_field( httpContext, "vGRIDCURRENTPAGE", GXutil.ltrim( localUtil.ntoc( AV40GridCurrentPage, (byte)(10), (byte)(0), ",", "")));
      com.GxWebStd.gx_hidden_field( httpContext, "vGRIDPAGECOUNT", GXutil.ltrim( localUtil.ntoc( AV41GridPageCount, (byte)(10), (byte)(0), ",", "")));
      com.GxWebStd.gx_hidden_field( httpContext, "vGRIDAPPLIEDFILTERS", AV8GridAppliedFilters);
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.GxWebStd.gx_hidden_field( httpContext, "vMANAGEFILTERSEXECUTIONSTEP", GXutil.ltrim( localUtil.ntoc( AV29ManageFiltersExecutionStep, (byte)(1), (byte)(0), ",", "")));
      com.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV47Pgmname));
      com.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV47Pgmname, ""))));
      com.GxWebStd.gx_hidden_field( httpContext, "vORDEREDBY", GXutil.ltrim( localUtil.ntoc( AV16OrderedBy, (byte)(4), (byte)(0), ",", "")));
      com.GxWebStd.gx_boolean_hidden_field( httpContext, "vORDEREDDSC", AV17OrderedDsc);
      ...
      com.GxWebStd.gx_hidden_field( httpContext, "WWPPARAMETERVALUE", A5WWPParameterValue);
   ...
   {
      return formatLink("com.workwithplus.wwp_parameterww", new String[] {}, new String[] {})  ;
   }
   ...
   public void wb0Q0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.GxWebStd.gx_label_ctrl( httpContext, lblBtninsert_Internalname, "<i class='fas fa-plus' title='Agregar'></i>", "", "", lblBtninsert_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", "", "", 5, "", 1, 1, 0, (short)(1), "HLP_WorkWithPlus/WWP_ParameterWW.htm");
         ...
         /* Div Control */
         com.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
         wb_table1_18_0Q2( true) ;
      }
      else
      {
         wb_table1_18_0Q2( false) ;
      }
      return  ;
   }

   public void wb_table1_18_0Q2e( boolean wbgen )
   {
      if ( wbgen )
      {
         com.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
                  ...
                  if ( GXutil.strcmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( GXutil.strcmp(GXutil.left( sEvt, 5), "START") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 7), "REFRESH") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 9), "GRID.LOAD") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 5), "ENTER") == 0 ) || ( GXutil.strcmp(GXutil.left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           A9WWPParameterValueTrimmed = httpContext.cgiGet( edtWWPParameterValueTrimmed_Internalname) ;
                           sEvtType = GXutil.right( sEvt, 1) ;
                           if ( GXutil.strcmp(sEvtType, ".") == 0 )
                           {
                              sEvt = GXutil.left( sEvt, GXutil.len( sEvt)-1) ;
   ...
   {
      com.GxWebStd.gx_hidden_field( httpContext, "gxhash_WWPPARAMETERKEY", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A4WWPParameterKey, ""))));
      com.GxWebStd.gx_hidden_field( httpContext, "WWPPARAMETERKEY", A4WWPParameterKey);
   }
   ...
   public void rf0Q2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         lV48Workwithplus_wwp_parameterwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV48Workwithplus_wwp_parameterwwds_1_filterfulltext), "%", "") ;
         lV48Workwithplus_wwp_parameterwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV48Workwithplus_wwp_parameterwwds_1_filterfulltext), "%", "") ;
         lV48Workwithplus_wwp_parameterwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV48Workwithplus_wwp_parameterwwds_1_filterfulltext), "%", "") ;
         /* Using cursor H000Q2 */
         pr_default.execute(0, new Object[] {lV48Workwithplus_wwp_parameterwwds_1_filterfulltext, lV48Workwithplus_wwp_parameterwwds_1_filterfulltext, lV48Workwithplus_wwp_parameterwwds_1_filterfulltext, Integer.valueOf(GXPagingFrom2), Integer.valueOf(GXPagingTo2), Integer.valueOf(GXPagingTo2)});
         nGXsfl_36_idx = 1 ;
         sGXsfl_36_idx = GXutil.padl( GXutil.ltrimstr( DecimalUtil.doubleToDec(nGXsfl_36_idx), 4, 0), (short)(4), "0") ;
         subsflControlProps_362( ) ;
         while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subgrid_fnc_recordsperpage( ) ) ) ) )
         {
            A8WWPParameterDisableDelete = H000Q2_A8WWPParameterDisableDelete[0] ;
            A7WWPParameterDescription = H000Q2_A7WWPParameterDescription[0] ;
            A6WWPParameterCategory = H000Q2_A6WWPParameterCategory[0] ;
            A4WWPParameterKey = H000Q2_A4WWPParameterKey[0] ;
            A5WWPParameterValue = H000Q2_A5WWPParameterValue[0] ;
   ...
   public void send_integrity_lvl_hashes0Q2( )
   {
      com.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV47Pgmname));
      com.GxWebStd.gx_hidden_field( httpContext, "gxhash_vPGMNAME", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( AV47Pgmname, ""))));
      com.GxWebStd.gx_hidden_field( httpContext, "gxhash_WWPPARAMETERKEY"+"_"+sGXsfl_36_idx, getSecureSignedToken( sGXsfl_36_idx, GXutil.rtrim( localUtil.format( A4WWPParameterKey, ""))));
   }
   ...
   public int subgrid_fnc_recordcount( )
   {
      ...
      lV48Workwithplus_wwp_parameterwwds_1_filterfulltext = GXutil.concat( GXutil.rtrim( AV48Workwithplus_wwp_parameterwwds_1_filterfulltext), "%", "") ;
      /* Using cursor H000Q3 */
      pr_default.execute(1, new Object[] {lV48Workwithplus_wwp_parameterwwds_1_filterfulltext, lV48Workwithplus_wwp_parameterwwds_1_filterfulltext, lV48Workwithplus_wwp_parameterwwds_1_filterfulltext});
   ...
   public void before_start_formulas( )
   {
      ...
      httpContext.ajax_rsp_assign_prop("", false, edtWWPParameterKey_Internalname, "Enabled", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtWWPParameterKey_Enabled), 5, 0), !bGXsfl_36_Refreshing);
      edtWWPParameterCategory_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtWWPParameterCategory_Internalname, "Enabled", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtWWPParameterCategory_Enabled), 5, 0), !bGXsfl_36_Refreshing);
      edtWWPParameterDescription_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtWWPParameterDescription_Internalname, "Enabled", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtWWPParameterDescription_Enabled), 5, 0), !bGXsfl_36_Refreshing);
      edtWWPParameterValueTrimmed_Enabled = 0 ;
      httpContext.ajax_rsp_assign_prop("", false, edtWWPParameterValueTrimmed_Internalname, "Enabled", GXutil.ltrimstr( DecimalUtil.doubleToDec(edtWWPParameterValueTrimmed_Enabled), 5, 0), !bGXsfl_36_Refreshing);
      fix_multi_value_controls( ) ;
   }
   ...
   public void strup0Q0( )
   {
      ...
      {
         /* Read saved SDTs. */
         httpContext.readJsonSdtValue(httpContext.cgiGet( "vMANAGEFILTERSDATA"), AV27ManageFiltersData);
         httpContext.readJsonSdtValue(httpContext.cgiGet( "vDDO_TITLESETTINGSICONS"), AV38DDO_TitleSettingsIcons);
         /* Read saved values. */
         nRC_GXsfl_36 = (int)(localUtil.ctol( httpContext.cgiGet( "nRC_GXsfl_36"), ",", ".")) ;
         AV40GridCurrentPage = localUtil.ctol( httpContext.cgiGet( "vGRIDCURRENTPAGE"), ",", ".") ;
         AV41GridPageCount = localUtil.ctol( httpContext.cgiGet( "vGRIDPAGECOUNT"), ",", ".") ;
         AV8GridAppliedFilters = httpContext.cgiGet( "vGRIDAPPLIEDFILTERS") ;
   ...
   public void e170Q2( )
   {
      ...
      GXt_char4 = AV8GridAppliedFilters ;
      GXv_char5[0] = GXt_char4 ;
      new com.wwpbaseobjects.wwp_getappliedfiltersdescription(remoteHandle, context).execute( AV47Pgmname, GXv_char5) ;
      wwp_parameterww_impl.this.GXt_char4 = GXv_char5[0] ;
      AV8GridAppliedFilters = GXt_char4 ;
      httpContext.ajax_rsp_assign_attri("", false, "AV8GridAppliedFilters", AV8GridAppliedFilters);
      AV48Workwithplus_wwp_parameterwwds_1_filterfulltext = AV19FilterFullText ;
   ...
   private void e180Q2( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV45Update);
      edtavUpdate_Link = formatLink("com.workwithplus.wwp_parameter", new String[] {GXutil.URLEncode(GXutil.rtrim("UPD")),GXutil.URLEncode(GXutil.rtrim(A4WWPParameterKey))}, new String[] {"Mode","WWPParameterKey"})  ;
      AV46Delete = "<i class=\"fa fa-times\"></i>" ;
      httpContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV46Delete);
      if ( ! A8WWPParameterDisableDelete )
      {
         edtavDelete_Link = formatLink("com.workwithplus.wwp_parameter", new String[] {GXutil.URLEncode(GXutil.rtrim("DLT")),GXutil.URLEncode(GXutil.rtrim(A4WWPParameterKey))}, new String[] {"Mode","WWPParameterKey"})  ;
   ...
   public void e110Q2( )
   {
      ...
      else if ( GXutil.strcmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
      {
         ...
         S152 ();
         if (returnInSub) return;
         com.genexus.webpanels.WebFrontendUtils.popup(formatLink("com.wwpbaseobjects.savefilteras", new String[] {GXutil.URLEncode(GXutil.rtrim("WorkWithPlus.WWP_ParameterWWFilters")),GXutil.URLEncode(GXutil.rtrim(AV47Pgmname+"GridState"))}, new String[] {"UserKey","GridStateKey"}) , new Object[] {}, httpContext);
         AV29ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV29ManageFiltersExecutionStep", GXutil.str( AV29ManageFiltersExecutionStep, 1, 0));
      ...
      {
         com.genexus.webpanels.WebFrontendUtils.popup(formatLink("com.wwpbaseobjects.managefilters", new String[] {GXutil.URLEncode(GXutil.rtrim("WorkWithPlus.WWP_ParameterWWFilters"))}, new String[] {"UserKey"}) , new Object[] {}, httpContext);
         AV29ManageFiltersExecutionStep = (byte)(2) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV29ManageFiltersExecutionStep", GXutil.str( AV29ManageFiltersExecutionStep, 1, 0));
         httpContext.doAjaxRefresh();
      }
      ...
      {
         GXt_char4 = AV28ManageFiltersXml ;
         GXv_char5[0] = GXt_char4 ;
         new com.wwpbaseobjects.getfilterbyname(remoteHandle, context).execute( "WorkWithPlus.WWP_ParameterWWFilters", Ddo_managefilters_Activeeventkey, GXv_char5) ;
         wwp_parameterww_impl.this.GXt_char4 = GXv_char5[0] ;
         AV28ManageFiltersXml = GXt_char4 ;
         ...
         else
         {
            ...
            S162 ();
            if (returnInSub) return;
            new com.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV47Pgmname+"GridState", AV28ManageFiltersXml) ;
   ...
   public void e150Q2( )
   {
      /* 'DoInsert' Routine */
      returnInSub = false ;
      callWebObject(formatLink("com.workwithplus.wwp_parameter", new String[] {GXutil.URLEncode(GXutil.rtrim("INS")),GXutil.URLEncode(GXutil.rtrim(""))}, new String[] {"Mode","WWPParameterKey"}) );
   ...
   public void S112( )
   {
      ...
      returnInSub = false ;
      GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item6 = AV27ManageFiltersData ;
      GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item7[0] = GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item6 ;
      new com.wwpbaseobjects.wwp_managefiltersloadsavedfilters(remoteHandle, context).execute( "WorkWithPlus.WWP_ParameterWWFilters", "", "", false, GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item7) ;
      GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item6 = GXv_objcol_SdtDVB_SDTDropDownOptionsData_Item7[0] ;
      AV27ManageFiltersData = GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item6 ;
   }
   ...
   public void S132( )
   {
      ...
      returnInSub = false ;
      if ( GXutil.strcmp(AV26Session.getValue(AV47Pgmname+"GridState"), "") == 0 )
      {
         AV14GridState.fromxml(new com.wwpbaseobjects.loadgridstate(remoteHandle, context).executeUdp( AV47Pgmname+"GridState"), null, null);
      }
      else
      {
         AV14GridState.fromxml(AV26Session.getValue(AV47Pgmname+"GridState"), null, null);
      }
      AV16OrderedBy = AV14GridState.getgxTv_SdtWWPGridState_Orderedby() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV16OrderedBy", GXutil.ltrimstr( DecimalUtil.doubleToDec(AV16OrderedBy), 4, 0));
      AV17OrderedDsc = AV14GridState.getgxTv_SdtWWPGridState_Ordereddsc() ;
   ...
   public void S172( )
   {
      ...
      returnInSub = false ;
      AV49GXV1 = 1 ;
      while ( AV49GXV1 <= AV14GridState.getgxTv_SdtWWPGridState_Filtervalues().size() )
      {
         AV15GridStateFilterValue = (com.wwpbaseobjects.SdtWWPGridState_FilterValue)((com.wwpbaseobjects.SdtWWPGridState_FilterValue)AV14GridState.getgxTv_SdtWWPGridState_Filtervalues().elementAt(-1+AV49GXV1));
   ...
   public void S152( )
   {
      ...
      GXv_SdtWWPGridState8[0] = AV14GridState;
      new com.wwpbaseobjects.wwp_gridstateaddfiltervalue(remoteHandle, context).execute( GXv_SdtWWPGridState8, "FILTERFULLTEXT", "Filtro principal", !(GXutil.strcmp("", AV19FilterFullText)==0), (short)(0), AV19FilterFullText, AV19FilterFullText, false, "", "") ;
      AV14GridState = GXv_SdtWWPGridState8[0];
      ...
      new com.wwpbaseobjects.savegridstate(remoteHandle, context).execute( AV47Pgmname+"GridState", AV14GridState.toxml(false, true, "WWPGridState", "Gregory")) ;
   }
   ...
   public void S122( )
   {
      ...
      returnInSub = false ;
      AV12TrnContext = (com.wwpbaseobjects.SdtWWPTransactionContext)new com.wwpbaseobjects.SdtWWPTransactionContext(remoteHandle, context);
      AV12TrnContext.setgxTv_SdtWWPTransactionContext_Callerobject( AV47Pgmname );
      ...
      AV12TrnContext.setgxTv_SdtWWPTransactionContext_Transactionname( "WorkWithPlus.WWP_Parameter" );
      AV26Session.setValue("TrnContext", AV12TrnContext.toxml(false, true, "WWPTransactionContext", "Gregory"));
   }

   public void wb_table1_18_0Q2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         wb_table2_23_0Q2( true) ;
      }
      else
      {
         wb_table2_23_0Q2( false) ;
      }
      return  ;
   }

   public void wb_table2_23_0Q2e( boolean wbgen )
   {
      if ( wbgen )
      {
         httpContext.writeText( "</td>") ;
         ...
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table1_18_0Q2e( true) ;
      }
      else
      {
         wb_table1_18_0Q2e( false) ;
      }
   }

   public void wb_table2_23_0Q2( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         ...
         com.GxWebStd.gx_single_line_edit( httpContext, edtavFilterfulltext_Internalname, AV19FilterFullText, GXutil.rtrim( localUtil.format( AV19FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,27);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Buscar", edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, (byte)(0), (short)(0), 0, (byte)(0), (byte)(-1), (byte)(-1), true, "WWPFullTextFilter", "start", true, "", "HLP_WorkWithPlus/WWP_ParameterWW.htm");
         com.GxWebStd.gx_div_end( httpContext, "start", "top", "div");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "</tr>") ;
         /* End of table */
         httpContext.writeText( "</table>") ;
         wb_table2_23_0Q2e( true) ;
      }
      else
      {
         wb_table2_23_0Q2e( false) ;
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?202442617165983", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("workwithplus/wwp_parameterww.js", "?202442617165983", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      httpContext.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public void subsflControlProps_362( )
   {
      ...
      edtWWPParameterKey_Internalname = "WWPPARAMETERKEY_"+sGXsfl_36_idx ;
      edtWWPParameterCategory_Internalname = "WWPPARAMETERCATEGORY_"+sGXsfl_36_idx ;
      edtWWPParameterDescription_Internalname = "WWPPARAMETERDESCRIPTION_"+sGXsfl_36_idx ;
      edtWWPParameterValueTrimmed_Internalname = "WWPPARAMETERVALUETRIMMED_"+sGXsfl_36_idx ;
   }
   ...
   public void subsflControlProps_fel_362( )
   {
      ...
      edtWWPParameterKey_Internalname = "WWPPARAMETERKEY_"+sGXsfl_36_fel_idx ;
      edtWWPParameterCategory_Internalname = "WWPPARAMETERCATEGORY_"+sGXsfl_36_fel_idx ;
      edtWWPParameterDescription_Internalname = "WWPPARAMETERDESCRIPTION_"+sGXsfl_36_fel_idx ;
      edtWWPParameterValueTrimmed_Internalname = "WWPPARAMETERVALUETRIMMED_"+sGXsfl_36_fel_idx ;
   }
   ...
   public void sendrow_362( )
   {
      ...
      if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_36_idx <= subgrid_fnc_recordsperpage( ) * 1 ) )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtWWPParameterKey_Internalname,A4WWPParameterKey,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtWWPParameterKey_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(300),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","start",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtWWPParameterCategory_Internalname,A6WWPParameterCategory,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtWWPParameterCategory_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(200),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","start",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtWWPParameterDescription_Internalname,A7WWPParameterDescription,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtWWPParameterDescription_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(200),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","start",Boolean.valueOf(true),""});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            httpContext.writeText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
         ...
         /* Single line edit */
         ROClassString = "Attribute" ;
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtWWPParameterValueTrimmed_Internalname,A9WWPParameterValueTrimmed,"","","'"+""+"'"+",false,"+"'"+""+"'","","","","",edtWWPParameterValueTrimmed_Jsonclick,Integer.valueOf(0),"Attribute","",ROClassString,"WWColumn","",Integer.valueOf(-1),Integer.valueOf(0),Integer.valueOf(0),"text","",Integer.valueOf(0),"px",Integer.valueOf(17),"px",Integer.valueOf(30),Integer.valueOf(0),Integer.valueOf(0),Integer.valueOf(36),Integer.valueOf(0),Integer.valueOf(-1),Integer.valueOf(-1),Boolean.valueOf(true),"","start",Boolean.valueOf(true),""});
   ...
   public void startgridcontrol36( )
   {
      if ( GridContainer.GetWrapped() == 1 )
      {
         ...
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         httpContext.writeValue( "Categoría") ;
         httpContext.writeTextNL( "</th>") ;
         httpContext.writeText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      else
      {
         ...
         GridColumn.AddObjectProperty("Value", WebUtils.htmlEncode( GXutil.rtrim( AV45Update)));
         GridColumn.AddObjectProperty("Enabled", GXutil.ltrim( localUtil.ntoc( edtavUpdate_Enabled, (byte)(5), (byte)(0), ".", "")));
         GridColumn.AddObjectProperty("Link", GXutil.rtrim( edtavUpdate_Link));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", WebUtils.htmlEncode( GXutil.rtrim( AV46Delete)));
         GridColumn.AddObjectProperty("Class", GXutil.rtrim( edtavDelete_Class));
         GridColumn.AddObjectProperty("Enabled", GXutil.ltrim( localUtil.ntoc( edtavDelete_Enabled, (byte)(5), (byte)(0), ".", "")));
         GridColumn.AddObjectProperty("Link", GXutil.rtrim( edtavDelete_Link));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", WebUtils.htmlEncode( A4WWPParameterKey));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", WebUtils.htmlEncode( A6WWPParameterCategory));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", WebUtils.htmlEncode( A7WWPParameterDescription));
         GridContainer.AddColumnProperties(GridColumn);
         GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         GridColumn.AddObjectProperty("Value", WebUtils.htmlEncode( A9WWPParameterValueTrimmed));
         GridContainer.AddColumnProperties(GridColumn);
   ...
   public void initialize_properties( )
   {
      ...
      Ddo_grid_Columnids = "2:WWPParameterKey|3:WWPParameterCategory|4:WWPParameterDescription" ;
   ...
   {
      setEventMetadata("REFRESH","{handler:'refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV29ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV19FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV47Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
      setEventMetadata("REFRESH",",oparms:[{av:'AV29ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV40GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV41GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV8GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV27ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV14GridState',fld:'vGRIDSTATE',pic:''}]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'e120Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV19FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV29ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV47Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'e130Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV19FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV29ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV47Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
      setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
      setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'e140Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV19FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV29ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV47Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
      ...
      setEventMetadata("GRID.LOAD","{handler:'e180Q2',iparms:[{av:'A4WWPParameterKey',fld:'WWPPARAMETERKEY',pic:'',hsh:true},{av:'A8WWPParameterDisableDelete',fld:'WWPPARAMETERDISABLEDELETE',pic:''}]");
      ...
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'e110Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV19FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV29ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV47Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV14GridState',fld:'vGRIDSTATE',pic:''}]");
      setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",",oparms:[{av:'AV29ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV14GridState',fld:'vGRIDSTATE',pic:''},{av:'AV16OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV17OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV19FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'},{av:'AV40GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV41GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV8GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV27ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''}]}");
      setEventMetadata("'DOINSERT'","{handler:'e150Q2',iparms:[{av:'A4WWPParameterKey',fld:'WWPPARAMETERKEY',pic:'',hsh:true}]");
   ...
   public void initialize( )
   {
      ...
      bodyStyle = "" ;
      GXKey = "" ;
      AV27ManageFiltersData = new GXBaseCollection<com.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>(com.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item.class, "Item", "", remoteHandle);
      AV8GridAppliedFilters = "" ;
      AV38DDO_TitleSettingsIcons = new com.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(remoteHandle, context);
      AV14GridState = new com.wwpbaseobjects.SdtWWPGridState(remoteHandle, context);
      A5WWPParameterValue = "" ;
      Ddo_grid_Caption = "" ;
      ...
      AV48Workwithplus_wwp_parameterwwds_1_filterfulltext = "" ;
      H000Q2_A8WWPParameterDisableDelete = new boolean[] {false} ;
      H000Q2_A7WWPParameterDescription = new String[] {""} ;
      H000Q2_A6WWPParameterCategory = new String[] {""} ;
      H000Q2_A4WWPParameterKey = new String[] {""} ;
      H000Q2_A5WWPParameterValue = new String[] {""} ;
      ...
      AV15GridStateFilterValue = new com.wwpbaseobjects.SdtWWPGridState_FilterValue(remoteHandle, context);
      GXv_SdtWWPGridState8 = new com.wwpbaseobjects.SdtWWPGridState[1] ;
      AV12TrnContext = new com.wwpbaseobjects.SdtWWPTransactionContext(remoteHandle, context);
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.workwithplus.wwp_parameterww__default(),
         new Object[] {
             new Object[] {
            H000Q2_A8WWPParameterDisableDelete, H000Q2_A7WWPParameterDescription, H000Q2_A6WWPParameterCategory, H000Q2_A4WWPParameterKey, H000Q2_A5WWPParameterValue
            }
            , new Object[] {
   ...
   private boolean[] H000Q2_A8WWPParameterDisableDelete ;
   private String[] H000Q2_A7WWPParameterDescription ;
   private String[] H000Q2_A6WWPParameterCategory ;
   private String[] H000Q2_A4WWPParameterKey ;
   private String[] H000Q2_A5WWPParameterValue ;
   private long[] H000Q3_AGRID_nRecordCount ;
   private com.genexus.webpanels.GXWebForm Form ;
   private GXBaseCollection<com.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> AV27ManageFiltersData ;
   ...
   private com.wwpbaseobjects.SdtWWPTransactionContext AV12TrnContext ;
   private com.wwpbaseobjects.SdtWWPGridState AV14GridState ;
   private com.wwpbaseobjects.SdtWWPGridState GXv_SdtWWPGridState8[] ;
   private com.wwpbaseobjects.SdtWWPGridState_FilterValue AV15GridStateFilterValue ;
   private com.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons AV38DDO_TitleSettingsIcons ;
...
final  class wwp_parameterww__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   protected Object[] conditional_H000Q2( ModelContext context ,
                                          ...
                                          String A4WWPParameterKey ,
                                          String A6WWPParameterCategory ,
                                          String A7WWPParameterDescription ,
                                          short AV16OrderedBy ,
                                          boolean AV17OrderedDsc )
   {
      ...
      sOrderString = "" ;
      if ( ! (GXutil.strcmp("", AV48Workwithplus_wwp_parameterwwds_1_filterfulltext)==0) )
      {
         addWhere(sWhereString, "(( WWPParameterKey like '%' || ?) or ( WWPParameterCategory like '%' || ?) or ( WWPParameterDescription like '%' || ?))");
      }
      else
      {
         GXv_int9[0] = (byte)(1) ;
                                         ...
                                         Object [] dynConstraints )
   {
      ...
      {
            case 0 :
                  return conditional_H000Q2(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
            case 1 :
                  return conditional_H000Q3(context, remoteHandle, httpContext, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , ((Number) dynConstraints[4]).shortValue() , ((Boolean) dynConstraints[5]).booleanValue() );
      }
